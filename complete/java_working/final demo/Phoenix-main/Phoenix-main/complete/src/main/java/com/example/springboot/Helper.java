...
public class Helper {
    ...
    public static CodeResolve getResponse(String path) throws IOException, InterruptedException {
        ...
        while (srcReader.hasNext() && gptReader.hasNext()) {
            srcLine = srcReader.nextLine().trim();
            gptLine = gptReader.nextLine().trim();
...
//        robert(s);
      // String srcFile = github("https://github.com/shiranbi07/Phoenix/blob/main/hackaton/amat/java/bug/BankAccount.java");
    }
